...
const ASSET_PROCESSING_CHECK_WAIT = process.env.ASSET_PROCESSING_CHECK_WAIT || 500
const ASSET_PROCESSING_CHECK_RETRIES = process.env.ASSET_PROCESSING_CHECK_RETRIES || 5
